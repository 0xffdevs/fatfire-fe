...
export default function Footer() {
  return (
    <footer
      className="border-t-2 border-green-400 mt-16 md:mt-20 lg:mt-24 bg-black flex justify-center"
    ...
    >
      <div className="container mx-auto container-spacing py-8 md:py-12 lg:py-16 max-w-7xl">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            <h3
              className="text-green-400 font-bold mb-4 md:mb-6 glitch"
              data-text="ABOUT"
            >
              ABOUT
            </h3>
            <p className="text-green-400 text-sm md:text-base opacity-80 leading-relaxed">
              Code your way to financial independence. Master high-value tech
          ...
          <div>
            ...
            <div className="flex gap-4 mb-4 md:mb-6">
              ...
              <a
                href="https://github.com/0xffdevs"
                target="_blank"
                rel="noopener noreferrer"
                className="text-green-400 hover:text-green-300 transition-colors"
              >
