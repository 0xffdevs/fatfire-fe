...
export const metadata: Metadata = {
  ...
  description:
    'Master high-value tech skills and smart investing strategies. Learn ZK proofs, Rust, Golang, and achieve FIRE.',
  keywords:
    'FIRE, financial independence, programming, rust, golang, solidity, investing, trading',
};
