    ...
    return (
        <div className="w-full flex flex-col items-center min-h-screen">
            ...
            <div className="mb-12 md:mb-16 text-center">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 md:mb-8 glitch" data-text="FINANCIAL CALCULATORS">
            ...
            <div className="w-full flex flex-col items-center mb-8 md:mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                    <button
                        ...
                        className={`card-terminal cursor-pointer transition-all text-center ${activeCalculator === 'compound' ? 'border-green-300 bg-green-900 bg-opacity-20' : ''
                            }`}
                    >
                        <TrendingUp className="w-8 h-8 md:w-10 md:h-10 text-green-400 mb-3 md:mb-4 mx-auto" />
                        <h3 className="font-bold text-green-400 mb-2">Compound Interest</h3>
                        <p className="text-xs md:text-sm text-green-400 opacity-60">Calculate wealth growth</p>
                    </button>

                    <button
                        onClick={() => setActiveCalculator('fire')}
                        className={`card-terminal cursor-pointer transition-all text-center ${activeCalculator === 'fire' ? 'border-green-300 bg-green-900 bg-opacity-20' : ''
                            }`}
                    >
                        <Target className="w-8 h-8 md:w-10 md:h-10 text-green-400 mb-3 md:mb-4 mx-auto" />
                        <h3 className="font-bold text-green-400 mb-2">FIRE Calculator</h3>
                        <p className="text-xs md:text-sm text-green-400 opacity-60">Plan early retirement</p>
                    </button>

                    <button
                        onClick={() => setActiveCalculator('sip')}
                        className={`card-terminal cursor-pointer transition-all text-center ${activeCalculator === 'sip' ? 'border-green-300 bg-green-900 bg-opacity-20' : ''
                            }`}
                    >
                        <PiggyBank className="w-8 h-8 md:w-10 md:h-10 text-green-400 mb-3 md:mb-4 mx-auto" />
                        <h3 className="font-bold text-green-400 mb-2">SIP Returns</h3>
                        <p className="text-xs md:text-sm text-green-400 opacity-60">Mutual fund projections</p>
                        </button>
                </div>
                </div>
            </div>
            ...
            {activeCalculator === 'compound' && (
                <div className="w-full flex flex-col items-center space-y-6 md:space-y-8">
                    <div className="terminal-window w-full max-w-5xl">
                        ...
                        <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-6 md:mb-8 text-green-400">COMPOUND INTEREST CALCULATOR</h2>
                    ...
                    <div className="terminal-window w-full max-w-6xl">
                        ...
                        <h3 className="text-lg md:text-xl lg:text-2xl font-bold mb-6 md:mb-8 text-green-400">RESULTS</h3>
            ...
            {activeCalculator === 'fire' && (
                <div className="w-full flex flex-col items-center space-y-6 md:space-y-8">
                    <div className="terminal-window w-full max-w-5xl">
                        ...
                        <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-6 md:mb-8 text-green-400">FIRE CALCULATOR</h2>
                    ...
                    <div className="terminal-window w-full max-w-6xl">
                        ...
                        <h3 className="text-lg md:text-xl lg:text-2xl font-bold mb-6 md:mb-8 text-green-400">FIRE ANALYSIS</h3>
            ...
            {/* Tips Section */}
            <div className="mt-12 md:mt-16 border-2 border-green-400 p-6 md:p-8 rounded-lg w-full max-w-4xl mx-auto">
                <div className="flex items-start gap-4 md:gap-6">
                    <Info className="w-5 h-5 md:w-6 md:h-6 text-green-400 mt-1 flex-shrink-0" />
                    <div>
                        <h3 className="text-lg md:text-xl font-bold text-green-400 mb-4 md:mb-6">PRO TIPS</h3>
                        <ul className="space-y-3 md:space-y-4 text-green-400 opacity-80 text-sm md:text-base">
